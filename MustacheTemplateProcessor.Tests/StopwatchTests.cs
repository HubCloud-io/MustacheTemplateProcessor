...
namespace MustacheTemplateProcessor.Tests
{
    ...
    public class StopwatchTests
    {
        ...
        public void Foo()
        {
            var expression = $@"<div class=""row bg-blue"" >

   <div class=""col-sm-12"">Заказ № {{{{header.number}}}} от {{{{header.date}}}}</div>
...
<div class=""row"">
       ...
       <div class=""col-sm-6"">
           ...
           <a  href=""/Public/PrintForm/Share?token={{{{printformsharetoken(4, header.id)}}}}"" target=""_blank"">Public link</a>
